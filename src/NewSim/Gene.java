...
public class Gene extends ArrayList<Double> {
	...
	protected final double initialmutationrate = 0.245*4; // 0.245 - Mathematically determined - 0.244949; // Wide = 0.5
	...
	public Gene(int size) {
		...
		for(int i=0; i<size; i++)
			this.add(initialmean + initialmutationrate * (Math.random()-0.5)); //this.add(0.055 + 0.25 * (Math.random()-0.5));
	}
