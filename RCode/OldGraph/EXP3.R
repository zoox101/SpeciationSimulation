...
df = c(
  ...
  "idom/meiosis/Output3.csv",
  "idom/meiosis/Output49.csv",
  "idom/meiosis/Output98.csv",
  "idom/meiosis/Output147.csv",
  "cdom/meiosis/Output1.csv",
  "cdom/meiosis/Output50.csv",
  "cdom/meiosis/Output98.csv",
